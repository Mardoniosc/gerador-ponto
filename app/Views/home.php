                    ...
                    <div class="col-xl-4 col-lg-4 d-xl-flex d-lg-flex align-items-center">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-6 d-xl-block d-lg-block d-flex align-items-center">
                                <div class="logo">
                                    <a href="<?php echo site_url("layout/"); ?>index-2.html"><img src="<?php echo site_url("layout/"); ?>assets/img/logo.png" alt=""></a>
                                </div>
                            </div>
                            ...
                            <nav class="navbar navbar-expand-lg">
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="<?php echo site_url("layout/"); ?>about.html">About <span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>event.html">Event</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>gallery.html">Gallery</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>top-dj.html">Top DJ</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>schedule.html">Schedule</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>blog.html">Blog</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>faq.html">Faq</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo site_url("layout/"); ?>contact.html">Contact</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                        ...
                        <div class="banner-bottom">
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-6 d-xl-block d-lg-block d-md-none">
                                    <div class="part-img">
                                        <img src="<?php echo site_url("layout/"); ?>assets/img/banner-bottom-img.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-6 d-xl-flex d-lg-flex d-md-block align-items-center">
                                    <div class="promo-video">
                                        <div class="part-icon">
                                            <a class="play-button venobox mfp-iframe" href="<?php echo site_url("layout/"); ?>https://www.youtube.com/watch?v=GT6-H4BRyqQ"><i class="fas fa-play"></i></a>
                                        </div>
                                        <div class="part-text">
                                            <h3>promo videos</h3>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 d-xl-flex d-lg-flex d-md-flex align-items-center">
                                    <div class="banner-buttons">
                                        <a href="<?php echo site_url("layout/"); ?>#">get ticket</a>
                                        <a href="<?php echo site_url("layout/"); ?>#">explore more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="<?php echo site_url("layout/"); ?>#v-pills-home" role="tab"
                                aria-controls="v-pills-home" aria-selected="true">Monday<span class="month-count">14 Feburary</span></a>
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="<?php echo site_url("layout/"); ?>#v-pills-profile" role="tab"
                                aria-controls="v-pills-profile" aria-selected="false">Tuesday<span class="month-count">15 Feburary</span></a>
                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="<?php echo site_url("layout/"); ?>#v-pills-messages" role="tab"
                                aria-controls="v-pills-messages" aria-selected="false">Wednesday<span class="month-count">16 Feburary</span></a>
                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="<?php echo site_url("layout/"); ?>#v-pills-settings" role="tab"
                                ...
                                <div id="accordion">
                                    <div class="card">
                                        <div class="card-header" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" role="button">
                                            <div class="part-img">
                                                <img src="<?php echo site_url("layout/"); ?>assets/img/gallery-1.jpg" alt="">
                                            </div>
                                            <div class="part-text">
                                    ...
                                    <div class="card">
                                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" role="button">
                                            <div class="part-img">
                                                <img src="<?php echo site_url("layout/"); ?>assets/img/gallery-2.jpg" alt="">
                                            </div>
                                            <div class="part-text">
                                    ...
                                    <div class="card">
                                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" role="button">
                                            <div class="part-img">
                                                <img src="<?php echo site_url("layout/"); ?>assets/img/gallery-3.jpg" alt="">
                                            </div>
                                            <div class="part-text">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-sm-6">
                        <div class="single-img">
                            ...
                            <div class="hover-effect">
                                <a href="<?php echo site_url("layout/"); ?>#"><i class="far fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xl-4 col-lg-4 d-xl-block d-lg-block d-none">
                        <div class="single-img">
                            <img src="<?php echo site_url("layout/"); ?>assets/img/gallery-4.jpg" alt="">
                            <div class="hover-effect">
                                <a href="<?php echo site_url("layout/"); ?>#"><i class="far fa-eye"></i></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="dj-slider">
                            <div class="single-dj">
                                <div class="part-img">
                                    <img src="<?php echo site_url("layout/"); ?>assets/img/dj-1.jpg" alt="">
                                    <div class="hover-effect">
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-twitter"></i></a>
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-pinterest-p"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="single-dj">
                                <div class="part-img">
                                    <img src="<?php echo site_url("layout/"); ?>assets/img/dj-2.jpg" alt="">
                                    <div class="hover-effect">
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-twitter"></i></a>
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-pinterest-p"></i></a>
                            ...
                            <div class="single-dj">
                                <div class="part-img">
                                    <img src="<?php echo site_url("layout/"); ?>assets/img/dj-3.jpg" alt="">
                                    <div class="hover-effect">
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-twitter"></i></a>
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-pinterest-p"></i></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 d-xl-block d-lg-block d-md-none">
                        <div class="part-img">
                            <img src="<?php echo site_url("layout/"); ?>assets/img/about-venu.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="part-text">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="single-ticket-price">
                            ...
                            <div class="part-button">
                                <a href="<?php echo site_url("layout/"); ?>#">Buy Ticket</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="single-blog">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="part-img">
                                        <img src="<?php echo site_url("layout/"); ?>assets/img/blog-1.jpg" alt="">
                                ...
                                <div class="col-xl-6 col-lg-6 d-xl-flex d-lg-flex align-items-center">
                                    <div class="part-text">
                                        ...
                                        <p class="last-line">Phasellus vehicula the justo eg
                                            diam in posuere.<a href="<?php echo site_url("layout/"); ?>blog-details.html">Read More!</a></p>
                        ...
                        <div class="single-blog">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 order-xl-last order-lg-last order-first">
                                    <div class="part-img">
                                        <img src="<?php echo site_url("layout/"); ?>assets/img/blog-2.jpg" alt="">
                                        <div class="date-on-img">
                                            <span class="date">04 may</span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="single-blog">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="part-img">
                                        <img src="<?php echo site_url("layout/"); ?>assets/img/blog-3.jpg" alt="">
                                        <div class="date-on-img">
                                            <span class="date">04 may</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-sm-8 col-md-12 col-12">
                                        <div class="part-text">
                                            ...
                                            <div class="social">
                                                ...
                                                <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-twitter"></i></a>
                                                <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-pinterest-p"></i></a>
                                                <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-instagram"></i></a>
                                                <a href="<?php echo site_url("layout/"); ?>#"><i class="fab fa-youtube"></i></a>
                                            </div>
                                            <div class="text">
                    ...
                    <div class="col-xl-7 col-lg-8">
                        <div class="footer-menu">
                            <nav class="navbar navbar-expand-lg">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo site_url("layout/"); ?>index-2.html">About <span class="sr-only">(current)</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo site_url("layout/"); ?>event.html">Event</a>
                                    </li>
